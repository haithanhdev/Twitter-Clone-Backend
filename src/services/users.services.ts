...
class UsersService {
  private signAccessToken({ user_id, verify }: { user_id: string; verify: UserVerifyStatus }) {
    return signToken({
      ...
      options: {
        expiresIn: envConfig.accessTokenExpiresIn as StringValue
      }
    })
  }
  ...
  private signRefreshToken({ user_id, verify, exp }: { user_id: string; verify: UserVerifyStatus; exp?: number }) {
    ...
    return signToken({
      ...
      privateKey: envConfig.jwtSecretRefreshToken as string,
      options: {
        expiresIn: envConfig.refreshTokenExpiresIn as StringValue
      }
    })
  }
  private signEmailVerifyToken({ user_id, verify }: { user_id: string; verify: UserVerifyStatus }) {
    return signToken({
      ...
      options: {
        expiresIn: envConfig.emailVerifyTokenExpiresIn as StringValue
      }
    })
  }
  ...
  private signForgotPasswordToken({ user_id, verify }: { user_id: string; verify: UserVerifyStatus }) {
    return signToken({
      ...
      options: {
        expiresIn: envConfig.forgotPasswordTokenExpiresIn as StringValue
      }
    })
  }
