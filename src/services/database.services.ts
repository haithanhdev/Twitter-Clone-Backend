...
const uri = `mongodb+srv://${envConfig.dbUsername}:${envConfig.dbPassword}@twitter.lecph.mongodb.net/?retryWrites=true&w=majority&appName=Twitter`
...
class DatabaseService {
  ...
  async indexRefreshTokens() {
    ...
    if (!exists) {
      ...
      //TTL: khi exp het han thi mongodb se tu dong xoa
